...
// 			$joinLang = false;
	...
	public function setPaginationLimits () {
		...
		//$limit = (int)$app->getUserStateFromRequest ($limitString, 'limit');
                $limit=  JRequest::getVar('limit',0,'get','int');
                //var_dump($limit); die();
                /*if(is_numeric($app->getUserStateFromRequest ($limitString, 'limit')) &&
                        $limit===0){
                    $limit=1000;
                }*/
...
// 		return false;
	...
	function getOrderByPriceLink()
	{
		$params=JRequest::get('get');

		if(isset($params['orderby']) && $params['orderby']='product_price')
		{
		...
		return JRoute::_('index.php?'.implode('&',$link),false);
	}
