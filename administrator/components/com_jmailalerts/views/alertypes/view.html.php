 ...
 * @subpackage Components
 */
class jmailalertsViewalertypes extends JView
{
	/*
	 * Alertypes view display method
	 * @return void
	 **/
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'ALERTYPES' ), 'alerttypes' );
		JToolBarHelper::deleteList();
		JToolBarHelper::editListX();
		JToolBarHelper::addNewX();
		
		// Get data from the model
		$alert_items		= & $this->get( 'Data');
		$this->assignRef('alert_items',		$alert_items);
