...
<?php	
	...
	if (uddeIMcheckJversion()==5) {	// only Joomla 3.0, bug fixed in Joomla 3.1
...
<?php	
    ...
    //TODO: NEW MESSAGES UDDEIM TAB
    $tabs->startTab(_UDDEADM_MESSAGES,"send-message-tab");
    $tabs->endTab(_UDDEADM_MESSAGES,"send-message-tab");
