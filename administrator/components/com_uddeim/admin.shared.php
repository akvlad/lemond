...
$versionstring	= "uddeIM 3.0";						// version string for about boxes
$checkversion	= "3.0";							// version as above for check for update - this is the version we have
$checkhotfix	= "0";								// version as above for check for update - this is the version we have
$configversion	= "2.3";							// this is the version number of the configuration file we expect to load
