...
$doc->addScriptDeclaration('
    jQuery(document).ready(function(){
        jQuery("#login-link").click(function() { alert("OK");
            jQuery.facebox({div: "#formlogin"},function(){
                jQuery(document).bind("reveal.facebox",function(){
                    jQuery("#facebox #login-form").ajaxForm({
                        success: function(json_response){
                            ...
                            if(response.status == 1){
                                ...
                                jQuery("#facebox #login-form #errors").html(response.message);
...
');
$doc->addScript(JURI::base(true).'/modules/mod_login/js/jquery.form.js');
?>
...
<?php else : ?>
<form id="login-form" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
    <div id="form-body">
		...
		<div id="form-login-password">
			<div id="div-inside">
				<label for="modlgn-passwd">Введите пароль<?php/* echo JText::_('JGLOBAL_PASSWORD')*/ ?></label>
