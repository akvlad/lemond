 ...
 *
 */
class plgVmShipmentCity_choose extends vmPSPlugin {
	 ...
	 * @author Valerie Isaksen
	 */
	function plgVmConfirmedOrder ($order_id, $cart/*, $order*/) {
		...
		$values['city'] = $this->getOrderWeight ($cart, $method->weight_unit);
	...
	public function plgVmDisplayListFEShipment (VirtueMartCart $cart, $selected = 0, &$htmlIn) {
                ...
                return $this->displayListFE ($cart, $selected, $htmlIn,-1);
	}
...
",$plugin->data);
                ...
                ob_start();
                include (JPATH_SITE.'/plugins/vmshipment/city_choose/tmpl/default.php');
					$html = ob_get_clean();
                return $html;
        }
