<div id="vm_popup_wrapper">
	...
	<div id="div-buttons-popup-cart">
		<div class="lets-go"><a  href="#" onclick="jQuery.facebox.close(); return false;"><img src="../templates/lemond/images/go-on-in-cart.png"></a></div>
		<div class="buy-it"> <a  href="<?= JRoute::_("index.php?option=com_virtuemart&view=cart") ?>"><img src="../templates/lemond/images/lets-buy-it-in-cart.png"></a></div>
	</div>
</div>
